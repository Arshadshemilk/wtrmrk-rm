...
Strategy:
  ...
  5. Total-war endgame dumps all reserves at the weakest enemy

Replicates the winning yellow player's approach observed in the replay.
"""
...
WEAKEST_ENEMY_VALUE_MULT_4P = 1.3
WEAKEST_ENEMY_VALUE_MULT_2P = 1.15
GANG_UP_VALUE_MULT = 1.3
...
def detect_enemy_planet_battles(world):
    """Detect where an enemy fleet attacks another enemy's planet — creating weak spots."""
    battles = []
...
def plan_moves(world, deadline=None):
    ...
    # Gang-up missions — exploit inter-enemy combat (4P advantage)
