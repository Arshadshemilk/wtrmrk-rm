...
MIN_SHIPS_MINE_ATTACK = 7  # was 10 - attack more frequently
MIN_SHIPS_TARGET_COOP_ATTACK = 15  # was 20 - lower coop threshold
COOP_PLANET_CAP = 12  # was 8 - concentrate more firepower
COLLIDE_TICK_THOLD = 1

FORMULA_DIST = 85  # was 100 - reward close targets more
FORMULA_PROD_MULT = 20  # was 15 - aggressively seek production
FORMULA_ENEMY_BONUS_MULT = 13  # was 10 - prioritize enemy planets
FORMULA_TOTAL_SHIPS_PERCENT = 0.55  # was 0.7 - less defensive
